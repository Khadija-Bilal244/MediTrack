...
/**
 * Transporter is created lazily inside sendReminderEmail so that
 * process.env.GMAIL_USER / GMAIL_PASS are guaranteed to be loaded
...
<tr><td style="padding:20px 40px 32px;text-align:center;border-top:1px solid #e6f7f5;">
  ...
  // Create transporter here (lazily) so dotenv has already loaded by this point
